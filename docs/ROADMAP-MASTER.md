...
**Current batch:** [BATCH-01.md](./BATCH-01.md) · **Status:** IN PROGRESS
...
|---------|-------|------------|--------|
| **1–3** | Cloud Agents + Bugbot | F3 | **Batch 1 IN PROGRESS** |
| **4–6** | Memory AI (docs + skills) | F2 | PENDING |
| **7–9** | Mobile + Slack + Automations + Grok | F4 | PENDING |
